...
public class CafeJava {
	...
	public static void main(String[] args) 
	{
		        ...
		        System.out.println(customer1 + pendingMessage  + " and " + displayTotalMessage + dripCoffee);
		        ...
		        if(isReadyOrder4)
		        {
		        	System.out.println(customer4  + readyMessage +" and your total is : "  + capuccino);
		        }
		        else {
		        ...
		        System.out.println(customer3 + " the difference you need to pay is :  " + (latte - dripCoffee));
